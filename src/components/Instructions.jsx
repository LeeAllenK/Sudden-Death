		...
		<>
			{setInstructions && (
				<section className="grid h-screen w-screen items-center justify-center grid-rows-[auto_auto]">
					<div className=" text-red-700 mt-2 animate-pulse max-w-full h-fit pt-5">
						<Backbtn
						...
						/></div>
					<p className="grid place-items-start text-white lg:text-5xl md:text-2xl sm:text-3xl text-xl  h-screen max-w-[99%] w-auto pl-10 ">
						<br />
